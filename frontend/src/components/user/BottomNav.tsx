      ...
      <div className="max-w-[600px] mx-auto px-2 py-2 safe-area-inset-bottom">
        <div className="flex items-center justify-around">
          ...
          <div className="flex flex-col items-center justify-center p-1">
            <div className="relative w-14 h-14 rounded-2xl bg-gradient-to-br from-accent-bitcoin via-accent-orange to-accent-gold dark:from-accent-bitcoin dark:via-accent-orange dark:to-accent-gold flex items-center justify-center shadow-2xl border-2 border-accent-bitcoin/30 dark:border-white/20">
